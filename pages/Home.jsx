      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        {historicalArtists.length > 0 && (
          <div style={{ marginBottom: 32 }}>
            <div style={{
              fontSize: 12, color: "#6b7280", letterSpacing: "0.2em",
              marginBottom: 16, display: "flex", alignItems: "center", gap: 8,
            }}>
              <span style={{ fontSize: 16 }}>🕰</span>
              ECHO OF THE PAST — 歴史上の偉人
            </div>
              ...
              {historicalArtists.map(artist => (
                ...
                >
                  <div style={{
                    ...
                    background: artist.avatar_url ? `url(${artist.avatar_url}) center/cover` : "linear-gradient(135deg, #a78bfa, #7c3aed)",
            ...
            <div style={{ display: "grid", gap: 12 }}>
              {modernArtists.map(artist => (
                ...
                >
                  <div style={{
                    width: 48, height: 48, borderRadius: "50%",
                    background: artist.avatar_url ? `url(${artist.avatar_url}) center/cover` : "linear-gradient(135deg, #60a5fa, #34d399)",
                    flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20,
                  }}>
                    {!artist.avatar_url && "◈"}
                  </div>
        ...
        {openQuestions.length > 0 && (
          <div style={{
            ...
            <div style={{ fontSize: 10, color: "#4b5563", letterSpacing: "0.2em", marginBottom: 12 }}>
              IDEASYNTHETIX — 世界からの問い
            </div>
        ...
        {/* ナビゲーション */}
        <div style={{
          display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center", marginTop: 40,
        }}>
          {[
